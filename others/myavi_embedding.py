...
class Visualization(HasTraits):
    ...
    def __init__(self, data):
        ...
        self.data = data
        self.plot = self.scene.mlab.plot3d(self.data[:,0], self.data[:,1], self.data[:,2], self.data[:,3], colormap='Spectral')

    @on_trait_change('self.data')
    def update_plot(self):
        ...
        self.plot.mlab_source.set(self.data[:,0], self.data[:,1], self.data[:,2], self.data[:,3])
...
if __name__ == "__main__":
    ...
    mayavi_widget = MayaviQWidget(container, data)
